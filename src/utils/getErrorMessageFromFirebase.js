export function getErrorMessageFromFirebaseError(error) {
    const errorMappings = {
        ...
        "auth/user-not-found": "User not found. Please make sure you have entered the correct information."
        // You can add more properties here to handle other specific Firebase errors.
    };
